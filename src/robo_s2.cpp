...
Sprint2::Sprint2() : Node("robo_s2"),angle_difference_(0.0), relative_orientaion_(0.0) {

    scan_subscriber_ = this->create_subscription<sensor_msgs::msg::LaserScan>(
        "/scan", 10, std::bind(&Sprint2::scanCallback, this, std::placeholders::_1));
...
void Sprint2::move_turtlebot(double move_f_b, double turn_l_r)
{
}

void Sprint2::scanCallback(const sensor_msgs::msg::LaserScan::SharedPtr msg) {
    // Convert LaserScan to cv::Mat (polar coordinates to Cartesian)
    cv::Mat img = Sprint2::laserScanToMat(msg);
...
cv::Mat Sprint2::laserScanToMat(const sensor_msgs::msg::LaserScan::SharedPtr& scan) {
    // Parameters
    int img_size = 500;
...
void Sprint2::calculateYawChange() {
